...
use Tec\DataSynchronize\Http\Requests\DownloadTemplateRequest;
use Tec\DataSynchronize\Http\Requests\ImportRequest;
use Tec\DataSynchronize\Importer\Importer;
use Exception;
...
abstract class ImportController extends BaseController
{
    ...
    public function validateData(ImportRequest $request)
    {
        try {
            ...
            $message = $response->getFromOffset() <= $response->getNextOffset() ? trans('packages/datasynchronize::datasynchronize.import.validating_message', [
        ...
        try {
            ...
            if ($from <= $to) {
                ...
                if ($total > 0) {
                    ...
                    $message = trans('packages/datasynchronize::datasynchronize.import.no_data_message', [
