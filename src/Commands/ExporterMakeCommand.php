...
#[AsCommand(name: 'datasynchronize:make:exporter', description: 'Make a new exporter')]
class ExporterMakeCommand extends GeneratorCommand
{
    ...
    protected function createController(): void
    {
        ...
        $this->call('datasynchronize:make:export-controller', [
        ...
        PanelSectionManager::setGroupId('datasynchronize')->beforeRendering(function () {
            PanelSectionManager::default()->registerItem(
                ...
                fn () => PanelSectionItem::make('{{ name }}')
                    ...
                    ->withRoute('tools.datasynchronize.export.{{ route }}.index')
            );
        });
        PHP;
